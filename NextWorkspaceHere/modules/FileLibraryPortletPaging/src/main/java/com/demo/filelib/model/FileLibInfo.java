...
private String fileName,thumbnail,downloadUrl,size,mime,extension,fileEntryId,fileVersion;
...
public String toString() {
	return "FileLibInfo [fileName=" + fileName + ", thumbnail=" + thumbnail + ", downloadUrl=" + downloadUrl + ", size="
			+ size + ", mime=" + mime + ", extension=" + extension + ", fileEntryId=" + fileEntryId + ", fileVersion="
			+ fileVersion + ", repositoryId=" + repositoryId + ", folderId=" + folderId + ", imageName=" + imageName
			+ ", fields=" + fields + "]";
}
}
