		...
		for (Folder folder : lFolder)
		{
			...
			if(folder.getName().equals(folderName)){
				...
				for(FileEntry fn:fl){
					...
					record.setCreationDate(new SimpleDateFormat("MM/dd/yyyy HH:mm:ss").format(fn.getCreateDate()).toString());
					record.setModifiedDate(new SimpleDateFormat("MM/dd/yyyy HH:mm:ss").format(fn.getModifiedDate()).toString() );
