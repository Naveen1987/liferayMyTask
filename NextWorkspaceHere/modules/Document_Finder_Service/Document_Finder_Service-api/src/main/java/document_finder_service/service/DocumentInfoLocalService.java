...
/**
 * Provides the local service interface for DocumentInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DocumentInfoLocalServiceUtil
...
public interface DocumentInfoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DocumentInfoLocalServiceUtil} to access the document info local service. Add custom service methods to {@link document_finder_service.service.impl.DocumentInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public DocumentInfo createDocumentInfo(long DocID);
	...
	*/
	...
	public DocumentInfo deleteDocumentInfo(DocumentInfo documentInfo);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public DocumentInfo deleteDocumentInfo(long DocID)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DocumentInfo fetchDocumentInfo(long DocID);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DocumentInfo getDocumentInfo(long DocID) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public DocumentInfo updateDocumentInfo(DocumentInfo documentInfo);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DocumentInfo> getDocumentInfos(int start, int end);
