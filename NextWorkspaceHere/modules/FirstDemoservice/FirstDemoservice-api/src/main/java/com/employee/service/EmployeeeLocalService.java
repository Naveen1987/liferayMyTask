...
/**
 * Provides the local service interface for Employeee. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EmployeeeLocalServiceUtil
...
public interface EmployeeeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmployeeeLocalServiceUtil} to access the employeee local service. Add custom service methods to {@link com.employee.service.impl.EmployeeeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public Employeee createEmployeee(long eid);
	...
	*/
	...
	public Employeee deleteEmployeee(Employeee employeee);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Employeee deleteEmployeee(long eid) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employeee fetchEmployeee(long eid);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Employeee getEmployeee(long eid) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Employeee> getEmployeees(int start, int end);
