...
/**
 * The base model interface for the Employeee service. Represents a row in the &quot;employee_naveen&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.employee.model.impl.EmployeeeModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.employee.model.impl.EmployeeeImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface EmployeeeModel extends BaseModel<Employeee> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a employeee model instance should use the {@link Employeee} interface instead.
	 */
